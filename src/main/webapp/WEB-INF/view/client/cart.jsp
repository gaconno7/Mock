    ...
    <div class="row">
                        ...
                        <c:when test="${not empty cartItems}">
                            <c:forEach var="item" items="${cartItems}">
                                <tr id="cart-item-${item.id}">
                                    ...
                                    <td><span id="price-${item.id}" class="price"><fmt:formatNumber type="number" value="${item.product.price}"/> đ</span></td>
                                    <td>
                                    ...
                                    <td><span class="subtotal" id="subtotal-${item.id}"><fmt:formatNumber type="number" value="${item.product.price * item.quantity}"/></span> đ</td>
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm p-4">
                ...
                <p class="d-flex justify-content-between">Tổng tiền: <strong><span id="selectedTotalPrice">0</span> đ</strong></p>
    ...
    function updateTotalCart() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                //$("#selectedTotalPrice").text(response.totalSelectedCartPrice + " đ");
