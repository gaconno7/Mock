    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            $("#confirmOrderBtn").click(function () {
                ...
                var totalPriceText = $(".total-price-value").text().replace("Tổng tiền:", "").replace(" VNĐ", "").replace(/,/g, "").trim();
        ...
        $(document).ready(function () {
            $("#applyvoucherBtn").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            $(".total-price").text("Tổng tiền: " + response.newTotalPrice.toLocaleString("en-US") + " VNĐ");
                            $(".total-price-value").text("Tổng tiền: " + response.newTotalPrice.toLocaleString("en-US") + " VNĐ");
