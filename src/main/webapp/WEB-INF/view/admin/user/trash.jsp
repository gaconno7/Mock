                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <c:forEach var="deletedUser" items="${deletedUsers}"
                                                        varStatus="status">
                                                        <tr>
                                                            <td>${status.index + 1}</td>
                                                            <td>${deletedUser.fullname}</td>
                                                            <td>${deletedUser.email}</td>
                                                            <td><strong>${deletedUser.role.name}</strong></td>
                                                            <td>${deletedUser.id}</td>
                                                            <td>
                                                                <a class="btn btn-success"
                                                                    href="/admin/user/${deletedUser.id}">Chi tiết</a>
