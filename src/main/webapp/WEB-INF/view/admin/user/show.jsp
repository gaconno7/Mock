                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-md-6 mb-4 manageItem"
                                    onclick="location.href='/admin/user/list/ROLE_ADMIN';" style="cursor: pointer;">
                                ...
                                <div class="col-xl-4 col-md-6 mb-4 manageItem"
                                    onclick="location.href='/admin/user/list/ROLE_SUPPLIER';" style="cursor: pointer;">
                                ...
                                <div class="col-xl-4 col-md-6 mb-4 manageItem"
                                    onclick="location.href='/admin/user/list/ROLE_USER';" style="cursor: pointer;">
