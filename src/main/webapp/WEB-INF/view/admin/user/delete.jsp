                                            ...
                                            <div class="row">
                                                <div class="col-12 mx-auto" style="margin-bottom: 400px;">
                                                    <div class="d-flex justify-content-between">
                                                        <h3>Xoá vĩnh viễn tài khoản <strong>${deleteUser.email}</strong>
                                                        </h3>
                                                    ...
                                                    <div class="alert alert-danger">
                                                        Bạn có chắc chắn muốn xoá vĩnh viễn tài khoản này?
                                                    </div>
                                                    <form:form method="post" action="/admin/user/perdelete"
