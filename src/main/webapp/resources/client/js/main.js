        ...
        if (userMessage) {
            ...
            $("#chatbot-content").append(
                `<div style="text-align: right; margin: 5px 0;">
                    <span style="background-color: #007bff; color: white; padding: 8px; border-radius: 8px; display: inline-block;">
                        ${userMessage}
                    </span>
                </div>`
            );

            $("#chatbot-input").val(""); // Xóa input

            // Tạo phản hồi (dùng API nếu có)
            setTimeout(() => {
                $("#chatbot-content").append(
                    `<div style="text-align: left; margin: 5px 0;">
                        <span style="background-color: #ddd; padding: 8px; border-radius: 8px; display: inline-block;">
